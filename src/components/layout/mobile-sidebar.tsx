...
export function MobileSidebar({ accountId }: MobileSidebarProps) {
  ...
  }, [currentAccountId, currentCampaignId, currentAdGroupId, open]);
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-1 text-xs text-muted-foreground flex-wrap">
                  ...
                  <span className="truncate max-w-[60px]">
                    {contextNames.accountName || '...'}
                  </span>
                  <span>/</span>
                  <Megaphone className="h-3 w-3 flex-shrink-0" />
                  <span className="truncate max-w-[60px]">
                    {contextNames.campaignName || '...'}
                  </span>
                </div>
                <div className="flex items-center gap-2">
